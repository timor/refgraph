...
identicon generation.  See [[jdenticon-custom][jdenticon]] for the modifications and their reason.

#+BEGIN_SRC html :tangle refgraph.html :noweb yes
  <!DOCTYPE html>
  <meta charset="utf-8">
  <style>
...
#+NAME: make_force_layout :noweb yes
#+BEGIN_SRC js
...
non-standard attribute so far, and is accessed by the [[jdenticon-custom][modified
jdenticon code]].
